...
const ProductMetrics = () => {
  ...
  useEffect(() => {
    ...
    if (filter === 'PRODUCT_COUNT') {
      ...
      filtered.sort((a, b) => {
        const countA = productCounts[a.productId];
        const countB = productCounts[b.productId];
            ...
            <div className="flex items-center justify-between mb-6">
              ...
              <div className="flex flex-col sm:flex-row items-end sm:items-center gap-4">
                ...
                <div className="text-sm text-gray-500">
                  Showing {((currentPage - 1) * itemsPerPage) + 1}-{Math.min(currentPage * itemsPerPage, filteredCartData.length)} of {filteredCartData.length} items
            ...
            {filteredCartData.length > 0 ? (
                    ...
                    <div className="hidden sm:flex-1 sm:flex sm:items-center sm:justify-between">
                      <div>
                        <p className="text-sm text-gray-700">
                          ...
                          <span className="font-medium">{filteredCartData.length}</span> results
                        </p>
                      </div>
                      <div>
              ...
              <div className="text-center py-12">
                ...
                <p className="text-gray-500">
                  {selectedProductId !== 'ALL' 
                    ? 'No items found for the selected product filter.'
