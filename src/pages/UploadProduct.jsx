...
const UploadProduct = () => {
  const [data,setData] = useState({
      ...
      price : "",
      discount : "",
      description : "🔧 Easy Customization: Fully adjustable to fit your needs\n🎨 Color & Text Control: Personalize every detail effortlessly\n🔊 Sound Effects: High-quality sounds included for a complete package\n⚡ Quick & Simple Setup: Get started fast with a step-by-step tutorial\ncontact : editwithsanjay@gmail.com for any doubts",
      more_details : {},
  })
            ...
            <form className='grid gap-4' onSubmit={handleSubmit}>
                ...
                <div className='grid gap-1'>
                  ...
                  <input 
                    ...
                    required
                    disabled
                    className='bg-gray-200 p-2 outline-none border cursor-not-allowed rounded'
                  />
                </div>
                ...
                <div className='grid gap-1'>
                  <label htmlFor='embedVideo' className='font-medium'>Embed Video</label>
                  <input 
                    id='embedVideo'
                    type='text'
                ...
                <div className='grid gap-1'>
                  <label htmlFor='driveLink' className='font-medium'>Drive Link</label>
                  <input 
                    id='driveLink'
                    type='text'
                    placeholder='Enter drive link URL'
                    value={data?.more_details?.driveLink || ""}
                    onChange={(e) => {
                      const value = e.target.value
                      setData((preve) => {
                        return {
                ...
                {/**add more field**/}
                  {
                    Object?.keys(data?.more_details)?.filter(k => k !== 'embedVideo' && k !== 'driveLink')?.map((k,index)=>{
                        return(
